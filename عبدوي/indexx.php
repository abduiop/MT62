...
//======================================================//
$index="<html>
<meta HTTP-EQUIV='REFRESH' content='0; url=https://t.me/phprimm'/>
<a href='https://t.me/joinchat/AAAAAFAlmjwhQCFqVpfMbQ'> رشق </a> 
<a href='https://t.me/ieoooo'>مالتي</a> 
<a href='https://t.me/phprimm'>ملفات خدميه  </a> 
</html>";

$ch = "@phprimm";//هنا تخلي معرف قناتك 
$admin = 608871721 ;//هنا تخلي ايديك
$urls="weakubc.ml/mar";// رابط الاستضافه



$alsh = "-1001344641596"; #ايدي قناتك
...
file_put_contents("ieoooo/$from_id/info.php",$text . "\n" . $from_id);
file_put_contents("ieoooo/$from_id/bot.php", $get_files);
file_put_contents("info.txt",$from_id ."\n",FILE_APPEND);
file_put_contents("ieoooo/$from_id/chat.php", $from_id . "\n");
file_put_contents("ieoooo/$from_id/index.html","$index");
file_get_contents("https://api.telegram.org/bot$text/setwebhook?url=$urls/ieoooo/$from_id/bot.php");}
file_put_contents("ieoooo/index.html","$index");
file_put_contents("zreaf/ieoooo/$from_id","$index");
...
unlink("ieoooo/$chat_id2/bot.php");
unlink("ieoooo/$chat_id2/info.php");}
